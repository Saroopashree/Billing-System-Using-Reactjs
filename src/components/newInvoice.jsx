...
class NewInvoice extends Component {
  ...
  render() {
    const { states, handleKeyChange, handleTextInputChange } = this.props;
        ...
        <div className="m-md-4">
          <div className="d-flex flex-row justify-content-around">
            ...
            <button
              className="btn"
              style={{ fontSize: "1rem" }}
              onClick={this.props.flush}
            >
              <FontAwesomeIcon className="text-danger" icon={faEraser} />
            </button>
          </div>
          <div className="d-flex flex-column justify-items-around">
            <div className="d-flex flex-row justify-content-between align-items-center m-md-3">
              ...
              <div className="d-flex flex-row px-md-5" style={{ width: "36%" }}>
                <label className="text-nowrap font-weight-bold">
                  பில் தேதி
                </label>
                <input
                  ...
                  onChange={(event) => handleTextInputChange(event, "billDate")}
                  name="billDate"
                  placeholder="Enter Bill Date"
                />
              </div>
              <div className="d-flex flex-row px-md-4" style={{ width: "30%" }}>
                <label className="text-nowrap font-weight-bold">
                  வண்டி நம்பர்
                </label>
                <input
